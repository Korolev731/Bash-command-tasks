...
Просмотрите файл /var/log/syslog и перейдите к концу файла.
Откройте файл /var/log/syslog и выведите номер 50-й строки.
Используйте less для просмотра вывода команды ls -l.
Откройте файл /var/log/syslog и найдите все вхождения слова hello.
```
# Команда nl
```
